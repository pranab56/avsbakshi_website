        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="pt-2">
            <Link
              ...
              className="w-full sm:w-auto text-center px-6 py-3.5 bg-[#D99722] hover:bg-[#A37428] text-white text-xs sm:text-sm font-semibold rounded-sm shadow-sm transition-colors inline-block"
            >
              Start Your Business
            </Link>
          </div>
