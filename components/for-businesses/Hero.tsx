        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="pt-2">
            <Link
              ...
              className="w-full sm:w-auto text-center px-6 py-3.5 bg-[#B78735] hover:bg-[#A37428] text-white text-xs sm:text-sm font-semibold rounded-sm shadow-sm transition-colors inline-block"
            >
              Start Your Business
            </Link>
          </div>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-8 pt-6 sm:pt-8 border-t border-white/10">
            <div>
              <h4 className="font-title text-xl sm:text-3xl font-bold text-white mb-0.5">3,400+</h4>
              <p className="text-[11px] sm:text-xs text-zinc-400 font-normal">Partner Salons</p>
            </div>
            <div>
              <h4 className="font-title text-xl sm:text-3xl font-bold text-white mb-0.5">98%</h4>
              <p className="text-[11px] sm:text-xs text-zinc-400 font-normal">Satisfaction Rate</p>
            </div>
            <div>
              <h4 className="font-title text-xl sm:text-3xl font-bold text-white mb-0.5">$3,800</h4>
        ...
        <div className="lg:col-span-6">
          <div className="relative rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-2xl shadow-black/30 h-[280px] sm:h-[580px] lg:h-[620px] w-full">
            <div
              ...
              style={{ backgroundImage: `url('https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=1200&q=80')` }}
            />
          </div>
        </div>
      </div>
