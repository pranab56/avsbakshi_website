...
export default function GetStartedCta() {
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
      <div className="relative rounded-[32px] sm:rounded-[44px] bg-gradient-to-br from-[#1E1C1A] via-[#151413] to-[#2B2319] text-white p-8 sm:p-16 lg:p-20 overflow-hidden shadow-2xl border border-[#B78735]/40 text-center">
        
        {/* Glow Background Elements */}
        <div className="absolute -top-24 -left-24 w-80 h-80 bg-[#B78735]/25 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-3xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-3 pt-2">
            <Link
              href="/search"
              className="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-[#B78735] hover:bg-[#A0732A] text-white text-xs sm:text-sm font-bold shadow-lg shadow-[#B78735]/30 transition-all flex items-center justify-center gap-2 group"
            >
