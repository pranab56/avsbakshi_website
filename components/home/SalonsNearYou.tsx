    ...
    <section className="container mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        ...
        <Link
          ...
          className="inline-flex items-center justify-center gap-2 px-5 py-2.5 sm:py-3 rounded-md border border-border bg-card text-xs font-semibold text-foreground hover:bg-accent hover:border-primary transition-all w-full sm:w-auto"
        >
          Browse all services
        ...
        {salons.map((salon) => (
          ...
          >
            <div className="relative h-56 overflow-hidden">
              ...
              />
              <span className="absolute text-green-900 top-3 left-3 bg-background/90 backdrop-blur-md text-[10px] font-semibold px-2.5 py-1 rounded-full text-foreground border border-border/50">
                {salon.badge}
              </span>
            </div>
            ...
            <div className="p-4 space-y-3 flex-1 flex flex-col justify-between">
              <div>
                <div className="flex items-start justify-between">
                  ...
                  <span className="  text-xs font-bold text-primary">{salon.price}</span>
                </div>
              ...
              <Link
                ...
                className="w-full text-center py-3 bg-primary hover:bg-primary/90 text-primary-foreground text-xs font-semibold rounded-lg shadow transition-colors block mt-2"
              >
                Book Appointment
              </Link>
            </div>
